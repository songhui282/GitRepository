...
<body>
	<div style="width: 100%; height: 98px; background-color: #74acdc;">
		<div style="float: left; width: 380px; height: 100%;line-height:80px;margin-left: -40px;">
			<a href="index.jsp" target="_top">
				<img src="${path }/images/reception/logo_1.png" alt="WiseMan logo" style="width: 70%; height: 80%;" />
			</a>
		</div>
		<div id="loginTeacher" style="float:right; width: 210px; height:100%;line-height: 80px;">
			<c:if test="${sessionScope.loginTeacher != null }">
				<a target="right" class="btn btn-default" href="../teachers" style="margin-left: 9px;border-radius:20px;">你好，
			...
			<a class="btn btn-default" href="../exitTeacher" target="_parent" style="border-radius:20px;">退出登录</a>
		</div>
	</div>
