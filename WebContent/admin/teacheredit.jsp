			...
			<div class="row clearfix">
				<div class="col-md-12 column">
					<form class="form-horizontal" role="form" id="teacherAction" action="teacher" method="post">
						...
						<div class="form-group">
							 <label for="adminPower" class="col-sm-2 control-label">权限</label>
							<div class="col-sm-5">
						...
						<div class="form-group">
							 <label for="teacherAccount" class="col-sm-2 control-label">登录账户</label>
							<div class="col-sm-5">
								<input class="form-control" id="teacherAccount" name="teacherAccount" type="text" value="${teacher.teacherAccount }" placeholder="登录账户" />
							</div>
						</div>
						<div class="form-group">
							 <label for="teacherPwd" class="col-sm-2 control-label">登录密码</label>
							<div class="col-sm-5">
								<input class="form-control" id="teacherPwd" name="teacherPwd" type="password" value="${teacher.teacherPwd }" placeholder="登录密码" />
							</div>
						</div>
						<br />
						<div class="form-group">
